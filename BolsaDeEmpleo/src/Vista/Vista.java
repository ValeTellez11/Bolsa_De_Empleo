...
import co.j256.ormlite.dao.Dao;
import co.j256.ormlite.dao.DaoManager;
import co.j256.ormlite.jdbc.JdbcConnectionSource;
import co.j256.ormlite.stmt.QueryBuilder;
...
public class Vista {
	...
	public static List<Aspirante> ordenarLista(String field, Boolean order, Dao listaAspirantes) throws SQLException {
	...
	public void mostrarMensaje1(String string) {
		// TODO Auto-generated method stub
